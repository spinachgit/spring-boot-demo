package com.roncoo.example.bbb.controller_11;
...
@RequestMapping("bbb")
@Controller
public class WebControllerBB {

	private static final Logger logger = LoggerFactory.getLogger(WebControllerBB.class);
