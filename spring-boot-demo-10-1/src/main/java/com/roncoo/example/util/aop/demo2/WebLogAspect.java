package com.roncoo.example.util.aop.demo2;
     ...
     */
     ...
     public void doBefore(JoinPoint joinPoint){
       // 接收到请求，记录请求内容
        ...
        //获取请求参数信息
        String paramData = request.getParameterMap().toString(); //项目中使用JsonUtils.toString();
        //设置客户端ip
...
//        HttpServletRequest request = attributes.getRequest();
        ...
        //设置返回值
        loggerEntity.setReturnData(returnData.toString());
        //执行将日志写入数据库
