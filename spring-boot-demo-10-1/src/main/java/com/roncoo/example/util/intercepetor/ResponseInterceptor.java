...
import com.roncoo.example.util.intercepetor.entity.ErrorMsg;
import com.roncoo.example.util.intercepetor.entity.ResponseHolder;
import com.roncoo.example.util.intercepetor.entity.ResponseModel;
...
public class ResponseInterceptor implements HandlerInterceptor {
	...
	public void afterCompletion(HttpServletRequest request, HttpServletResponse response, Object object, Exception exception) throws Exception {
		...
		ResponseModel model = responseHolder.getModel();
		//String json = JSONUtil.toJSONString(responseHolder.getModel());
