...
public class ArrayUtil {
	...
	public static String[] getOneArray(String aa, String bb) {
		String[] a = StringUtil.isNotNullAndBlank(aa) ? aa.split(",") : new String[0];
		String[] b = StringUtil.isNotNullAndBlank(bb) ? bb.split(",") : new String[0];
	...
	public static String arrayListToString(List<String> arrayList) {
		...
		if (arrayList != null && arrayList.size() > 0) {
			...
			if (StringUtil.isNotNullAndBlank(sb.toString())) {
