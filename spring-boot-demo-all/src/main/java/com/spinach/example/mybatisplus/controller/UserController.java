package com.spinach.example.mybatisplus.controller;
...
public class UserController {
    ...
    public Page<User> test() {
    	Page<User> result = userService.selectPage(new Page<User>(0, 12));
    ...
    public String createTable(String sql) {
    	...
    	map.put("sql", sql);
    	userService.createTableSql(map);
    	return "操作成功！";
    }
}
