...
package com.spinach.example.util.configuration;
...
public class JavaMailSenderDemoImpl extends JavaMailSenderImpl implements JavaMailSender {
	...
	public JavaMailSenderDemoImpl(MailProperties properties) {
