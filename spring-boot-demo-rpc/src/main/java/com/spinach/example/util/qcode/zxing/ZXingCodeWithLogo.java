 ...
 */
public class ZXingCodeWithLogo {
	static String content = "怎么样，不错吧，定制二维码~~ 哈哈~~~";
	static String imagePath = "/users/apple/logs/qcode/spinach_QRCode.png";
	static String logoPath = "/users/apple/logs/qcode/logo2.png";
	static String outPath = "/users/apple/logs/qcode/test2.png";
	...
	public static void main(String[] args) throws WriterException {
		...
		try {
			...
			ZXingCodeWithLogo zp = new ZXingCodeWithLogo();
			...
			zp.addLogo_QRCode(file, new File(logoPath), new LogoConfig(),new File(outPath));
	 ...
	 * @param outFile 
	 */
	public void addLogo_QRCode(File qrPic, File logoPic, LogoConfig logoConfig, File outFile) {
		try {
			 ...
			 */
			int widthLogo = logo.getWidth(null) > image.getWidth() * 2 / 10 ? (image.getWidth() * 2 / 10) : logo.getWidth(null), heightLogo = logo.getHeight(null) > image.getHeight() * 2 / 10 ? (image
