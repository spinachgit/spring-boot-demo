...
public class CommonTool {
	...
	public static int obj2Int(Object obj) {
		...
		if (!StringUtils.isNumeric(obj.toString())) {
			throw new RuntimeException("ERROR.COMMON.002", null);
		}
	 ...
	 * @return
	 */
	public static String getRedisData(ValueOperations<String, String> vo, String key) {
		String value = "";
	 ...
	 * @param value
	 */
	public static void setRedisData(ValueOperations<String, String> vo, String key, String value) {
		try {
			vo.set(key, value);
		} catch (Exception e) {
			logger.info(e.getMessage());
	 ...
	 * @return
	 */
	public static String getRedisData(HashOperations<String, String, String> vo, String key, String hashKey) {
		String value = "";

		try {
			value = vo.get(key, hashKey);
		} catch (Exception e) {
			logger.info(e.getMessage());
		}
	 ...
	 * @param value
	 */
	public static void setRedisData(HashOperations<String, String, String> vo, String key, String hashKey, String value) {
		try {
			vo.put(key, hashKey, value);
		} catch (Exception e) {
			logger.info(e.getMessage());
		}
	}
	 ...
	 * @param map
	 */
	public static void setRedisData(HashOperations<String, String, String> vo, String key, Map<String, String> map) {
		try {
			vo.putAll(key, map);
		} catch (Exception e) {
			logger.info(e.getMessage());
