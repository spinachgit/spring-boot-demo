...
<body>
	<center>
		...
		<span>JS:</span>
		<textarea id="js_content" placeholder="请输入JS对应的内容">
...
$.post(url,data,function(body,status){
	...
	alert("数据: \n" + body + "\n状态: " + status);
		...
		<hr />
		<span>url:</span><input type="url" id="js_url" placeholder="url" value="http://localhost:8080/web/index" /><br /> <span>data:</span>
		<textarea id="js_data" placeholder="json字符串">
{	
	"name":"spinach"
}
</textarea>
